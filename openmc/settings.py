    ...
    **kwargs : dict, optional
    ...
    random_ray : dict
        ...
        :volume_estimator:
            ...
            is 'hybrid'. The 'adaptive' estimator generalizes 'hybrid': it uses
            ...
            source (kappa test) and in regions whose accumulated flux is
            negative at the end of the inactive phase (a one-shot demotion for
            the active batches), which removes the negative-flux instabilities
            'hybrid' can exhibit in optically thin, in-scatter-fed regions.
        :source_shape:
