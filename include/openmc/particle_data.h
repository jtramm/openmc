...
private:
  ...
  double wgt_born_ww_ {-1.0}; //!< weight at birth for weight windows
  double mu_;
  double time_ {0.0};
...
public:
  ...
  // Statistic weight window value of particle at birth
  double& wgt_born_ww() { return wgt_born_ww_; }
  double wgt_born_ww() const { return wgt_born_ww_; }
