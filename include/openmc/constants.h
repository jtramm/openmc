...
enum class RandomRayVolumeEstimator { NAIVE, SIMULATION_AVERAGED, SOURCE_CORRECTED, SEGMENT_CORRECTED };
enum class RandomRayMissFluxMethod { OLD_FLUX, SOURCE, ZERO };
